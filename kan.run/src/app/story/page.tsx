...
const careerData = [
  ...
  },
  {
    ...
    title: '株式会社ツクリエに入社',
    details: [
      'AIを使ったサービス開発を軸に、フロントエンドとバックエンドの開発を行っています',
    ],
  },
  {
    period: '2024年1月~',
  ...
  },
  {
    period: '2024年5月',
    title:
      '「林修の今知りたいでしょ！」にAIボイスクローン・AIアバター生成の技術提供',
    details: [
...
function CareerItem({ period, title, details }: CareerItemProps) {
  return (
    <div className="border-l-4 border-gray-200 px-4 py-2">
